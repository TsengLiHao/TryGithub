...
namespace VehicleLicenseTax
{
    public partial class VehicleLicenseTaxForm : Form
    {
        ...
        private void btnCommit_Click(object sender, EventArgs e)
        {
            ...
            //        //this.listBox1.Items.Add($"使用期間 : {this.dateTimePicker1.Value.ToString("yyyy/MM/dd")} ~{this.dateTimePicker2.Value.ToString($"{dateTimePicker1.Value.Year}/12/31")} ");
            //        for (int i = dateTimePicker1.Value.Year; i <= dateTimePicker2.Value.Year; i++)
            //        {

            //            //this.listBox1.Items.Add($"使用期間 : {this.dateTimePicker1.Value.ToString($"{dateTimePicker1.Value.AddYears(1)}/01/01")} ~{this.dateTimePicker2.Value.ToString($"{dateTimePicker1.Value.Year}/12/31")} ");
        ...
        //private void anotherYear()
        //{
        //    if (dateTimePicker1.Value.Year != DateTime.Now.Year)
        //    {
        //        //this.lblResult1.Text += $"使用期間 : {dateTimePicker1.Value.ToString("yyyy/MM/dd")} ~ {dateTimePicker1.Value.ToString("yyyy/12/31")}" + Environment.NewLine ;
        //        this.listBox1.Items.Add( $"使用期間 : {dateTimePicker1.Value.ToString("yyyy/MM/dd")} ~ {dateTimePicker1.Value.ToString("yyyy/12/31")}");
        //        this.listBox1.Items.Add("");
        //        this.listBox1.Items.Add("計算天數 : ");
        //        this.listBox1.Items.Add("計算天數 : ");
        //        this.listBox1.Items.Add("計算天數 : ");
        //        this.listBox1.Items.Add("計算天數 : ");
